...
(function() {
  ...
  find_names_text = function(me, points) {
    var R;
    R = ISL.match_common(me, points, {
      pick: 'name'
    });
    R.sort();
    return R.join(',');
  ...
  this["unique names with priority conflict"] = function(T) {
    ...
    T.eq(ISL.match_common(isl, [15, 16, 30], {
      pick: 'name'
  ...
  if (module.parent == null) {
    include = ["test interval tree 1", "test interval tree 2", "test interval tree 3", "aggregation 1", "aggregation 2", "characters as points 1", "characters as points 3", "intervals_from_points", "readme example 1", "readme example 2", "intervals without ID, name", "demo discontiguous ranges", "unique names with priority conflict", "tag 1", "tag 2", "tag 2a", "tag 2b", "tag 3", "configurable reducers, negative tags", "complements", "infinity is a valid number", "(v3) match, intersect"];
    this._prune();
    this._main();
  }
