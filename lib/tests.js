...
(function() {
  ...
  if (module.parent == null) {
    include = ["test interval tree 1", "test interval tree 2", "test interval tree 3", "aggregation", "characters as points 1", "characters as points 2", "characters as points 3", "intervals_from_points", "new API for points"];
    this._prune();
    this._main();
  }
