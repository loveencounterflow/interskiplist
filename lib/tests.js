...
(function() {
  ...
  this["readme example 2"] = function(T) {
    ...
    debug(ISL.aggregate(css_rules, 'A'));
    debug(ISL.aggregate(css_rules, '&'));
    return debug(ISL.aggregate(css_rules, '人'));
  };

  if (module.parent == null) {
    include = ["test interval tree 1", "test interval tree 2", "test interval tree 3", "aggregation", "characters as points 1", "characters as points 2", "characters as points 3", "intervals_from_points", "new API for points", "readme example 1", "readme example 2"];
    this._prune();
    this._main();
  }
