...
(function() {
  ...
  this["(v2) create custom aggregate"] = function(T) {
    var i, len, my_aggregate, probe, reducers, ref, u;
    u = ISL["new"]();
    ISL.add(u, {
      lo: 'q',
      hi: 'q',
