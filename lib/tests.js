...
(function() {
  ...
  this["(v2) query for fact"] = function(T) {
    var u;
    ISL.find_ids = function(me, name, value) {
      var R, index, ref;
      if ((index = (ref = me['indexes']) != null ? ref[name] : void 0) == null) {
    ...
    ISL.find_entries = function(me, name, value) {
      var R, i, id, idx, len;
