...
(function() {
  ...
  this["characters as points"] = function(T) {
    var i, isl, len, letter, ref;
    isl = ISL["new"]();
    ISL.insert(isl, {
      lo: 'a',
      hi: 'z',
  ...
  if (module.parent == null) {
    include = ["test interval tree 1", "test interval tree 2", "test interval tree 3", "aggregation", "characters as points"];
    this._main();
  }
