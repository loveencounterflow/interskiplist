...
//.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["(v2) match, intersect"] = function(T) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["(v2) copy"] = function(T) {
    var copy, i, j, key, len, len1, original, ref, ref1;
    original = ISL.new();
    ISL.add(original, {
      lo: 0x00,
      hi: 0x7f,
    ...
    ref = ['entry-by-ids', 'idx-by-names', 'ids-by-names', 'name-by-ids', 'idx-by-ids', 'ids'];
    // debug '9285', original
    // urge  '9285', copy
    //.........................................................................................................
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      T.ok(original[key] !== copy[key]);
    }
    ref1 = ['idx', 'min', 'max', 'fmin', 'fmax'];
    //.........................................................................................................
    for (j = 0, len1 = ref1.length; j < len1; j++) {
      key = ref1[j];
      T.ok(original[key] === copy[key]);
  ...
  this["(v2) 53846537846"] = function(T) {
    var i, len, matcher, probe, probes_and_matchers, reducers, result_A, result_B, u;
    u = ISL.new();
    ISL.add(u, {
      lo: 'q',
      hi: 'q',
  ...
  this["(v2) query for fact"] = function(T) {
    ...
    T.eq(ISL.find_entries(u, 'tag', 'cjk'), [
      {
        "lo": 37324,
        "hi": 37324,
        "tag": ["cjk",
    ...
    T.eq(ISL.find_entries(u, 'tag', 'assigned'), [
      {
        "lo": 113,
        "hi": 113,
        "tag": ["assigned"],
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["(v2) query for fact works with copied ISL"] = function(T) {
    var u_1, u_2;
    //.........................................................................................................
    u_1 = ISL.new();
    ...
    T.eq(ISL.find_entries(u_2, 'tag', 'cjk'), [
      {
        "lo": 37324,
        "hi": 37324,
        "tag": ["cjk",
    ...
    T.eq(ISL.find_entries(u_2, 'tag', 'assigned'), [
      {
        "lo": 113,
        "hi": 113,
        "tag": ["assigned"],
    ...
    T.eq(ISL.find_entries(u_2, 'rsg', 'u-latn'), [
      {
        "lo": 113,
        "hi": 113,
        "tag": ["assigned"],
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["(v2) cannot add index twice"] = function(T) {
    var rsg_index, u;
    //.........................................................................................................
    u = ISL.new();
    rsg_index = ISL.add_index(u, 'rsg');
    T.throws("index for 'rsg' already exists", () => {
      return ISL.add_index(u, 'rsg');
    });
    T.throws("no index for field 'NOSUCHINDEX'", () => {
      return ISL.delete_index(u, 'NOSUCHINDEX');
    });
    T.ok(rsg_index === ISL.delete_index(u, 'rsg'));
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["(v2) aggregate rejects multiple points"] = function(T) {
    var u;
    u = ISL.new();
    ISL.add_index(u, 'tag');
    ISL.add_index(u, 'rsg');
    ...
    T.throws("need single point, got 2", () => {
      return ISL.aggregate(u, ['q', '里']);
    });
    //.........................................................................................................
    return null;
  };
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["(v2) to_xjson, new_from_xjson"] = function(T) {
    var reducers, u_1, u_2, u_json_1, u_json_2;
    reducers = {
      fallback: 'skip',
      fields: {
        'tag': 'tag',
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["(v2) create custom aggregate"] = function(T) {
    var i, j, len, len1, my_aggregate, probe, reducers, ref, ref1, result_A, result_B, u;
    u = ISL.new();
    ISL.add(u, {
      lo: 'q',
      hi: 'q',
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      T.ok(result_A !== result_B);
      T.ok(result_B === my_aggregate(probe));
    }
    //.........................................................................................................
    my_aggregate = ISL.aggregate.use(u, reducers, {
      memoize: false
