...
(function() {
  var CND, ISL, alert, badge, debug, echo, find_ids_text, help, hex, include, info, list, log, rpr, s, show, test, urge, warn, whisper,
  ...
  this["test interval tree 2"] = function(T) {
    var hi, i, intervals, isl, len, lo, ref, tag;
    isl = ISL["new"]();
    ...
    for (i = 0, len = intervals.length; i < len; i++) {
      ref = intervals[i], lo = ref[0], hi = ref[1], tag = ref[2];
      ISL.add(isl, {
        lo: lo,
        hi: hi,
        tag: tag
  ...
  this["aggregation 2"] = function(T) {
    ...
    T.eq(ISL._OLD_aggregate(isl, 5, reducers), {
      "lo": 3,
      "hi": 7,
      "id": ["wide", "narrow"],
      "count": 14,
  ...
  this["readme example 2"] = function(T) {
    ...
    urge('rx2-7', 'A', ISL._OLD_aggregate(samples, 'A'));
    urge('rx2-8', '&', ISL._OLD_aggregate(samples, '&'));
    urge('rx2-9', '人', ISL._OLD_aggregate(samples, '人'));
    replacers = {
      '*': 'list',
      name: 'list'
    };
  ...
  this["tag 2a"] = function(T) {
    ...
    for (j = 0, len = probes_and_matchers.length; j < len; j++) {
      ...
      result = ISL._OLD_aggregate(u, probe, {
        name: 'skip'
      });
      T.eq(result, matcher);
    }
  ...
  this["infinity is a valid number"] = function(T) {
    ...
    T.eq(ISL._OLD_aggregate(r, 1, {
      name: 'skip'
    }), {
      "tag": ["all", "finite", "truly-huge", "huge", "big", "sizable", "small", "tiny"]
    });
    T.eq(ISL._OLD_aggregate(r, 10, {
      name: 'skip'
    }), {
      "tag": ["all", "finite", "truly-huge", "huge", "big", "sizable", "small"]
    });
    T.eq(ISL._OLD_aggregate(r, 100, {
      name: 'skip'
    }), {
      "tag": ["all", "finite", "truly-huge", "huge", "big", "sizable"]
    });
    T.eq(ISL._OLD_aggregate(r, 1000, {
      name: 'skip'
    }), {
      "tag": ["all", "finite", "truly-huge", "huge", "big"]
    });
    T.eq(ISL._OLD_aggregate(r, 10000, {
      name: 'skip'
    }), {
      "tag": ["all", "finite", "truly-huge", "huge"]
    });
    T.eq(ISL._OLD_aggregate(r, 100000, {
      name: 'skip'
    }), {
      "tag": ["all", "finite", "truly-huge"]
    });
    T.eq(ISL._OLD_aggregate(r, 1000000, {
      name: 'skip'
    }), {
      "tag": ["all", "finite"]
    });
    T.eq(ISL._OLD_aggregate(r, Infinity, {
      name: 'skip'
    }), {
      tag: ['all']
    });
  ...
  this["(v2) copy"] = function(T) {
    var copy, i, j, key, len, len1, original, original_value, ref, ref1, ref2;
    original = ISL["new"]({
      reducers: {
        name: 'list',
        tag: function(ids_and_values) {
          return '*';
        }
      }
    });
    ...
    if (original['reducers'] != null) {
      ref2 = original['reducers'];
      for (key in ref2) {
        original_value = ref2[key];
        if (CND.isa_function(original_value)) {
          T.ok(original_value === copy['reducers'][key]);
        } else {
  ...
  this["(v2) 53846537846"] = function(T) {
    var i, len, matcher, probe, probes_and_matchers, reducers, ref, result_A, result_B, u;
    u = ISL["new"]();
    ISL.add(u, {
      lo: 'q',
      hi: 'q',
  ...
  this["(v2) cannot add index twice"] = function(T) {
    ...
    T.throws("index for 'rsg' already exists", (function(_this) {
      return function() {
        return ISL.add_index(u, 'rsg');
      };
    })(this));
    T.throws("no index for field 'NOSUCHINDEX'", (function(_this) {
      return function() {
  ...
  this["(v2) _OLD_aggregate rejects multiple points"] = function(T) {
    var u;
    u = ISL["new"]();
    ISL.add_index(u, 'tag');
    ISL.add_index(u, 'rsg');
    ...
    T.throws("need single point, got 2", (function(_this) {
      return function() {
        return ISL._OLD_aggregate(u, ['q', '里']);
      };
    })(this));
    return null;
  };

  this["(v2) to_json, new_from_json"] = function(T) {
  ...
  this["(v2) [intermittent]"] = function(T) {
    var u;
    u = ISL["new"]();
    ISL.add(u, {
      lo: 'q',
  ...
  if (module.parent == null) {
    include = ["test interval tree 1", "test interval tree 2", "test interval tree 3", "aggregation 1", "aggregation 2", "characters as points 1", "intervals_from_points", "readme example 1", "readme example 2", "intervals without ID, name", "demo discontiguous ranges", "unique names with priority conflict", "tag 1", "tag 2", "tag 2a", "tag 2b", "tag 3", "configurable reducers, negative tags", "complements", "infinity is a valid number", "(v2) match, intersect", "(v2) copy", "(v2) 53846537846", "(v2) query for fact", "(v2) query for fact works with copied ISL", "(v2) cannot add index twice", "(v2) _OLD_aggregate rejects multiple points", "(v2) [intermittent]"];
    this._prune();
    this._main();
  }
