...
(function() {
  ...
  if (module.parent == null) {
    include = ["test interval tree 1", "characters as points 1", "intervals_from_points", "readme example 1", "demo discontiguous ranges", "tag 1", "tag 2", "tag 2a", "tag 2b", "tag 3", "negative tags", "complements", "infinity is a valid number", "(v2) copy", "(v2) 53846537846", "(v2) query for fact", "(v2) query for fact works with copied ISL", "(v2) cannot add index twice", "(v2) to_xjson, new_from_xjson", "(v2) aggregate rejects multiple points", "(v2) create custom aggregate", "aggregation 1", "aggregation 2"];
    this._prune();
    this._main();
  }
