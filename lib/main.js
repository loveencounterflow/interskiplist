...
(function() {
  ...
  this.aggregate = function(me, point, reducers) {
    var entries, point_count, reducer_mixins;
    if (reducers == null) {
      reducers = null;
    }
    ...
    reducer_mixins = [{}];
    reducer_mixins.push(this.aggregate._reducers);
    reducer_mixins.push(me['reducers']);
    if (reducers != null) {
      reducer_mixins.push(reducers);
    }
    reducers = Object.assign.apply(Object, reducer_mixins);
    mix = this.aggregate._get_mix(reducers);
    return mix.apply(null, entries);
  };

  this.aggregate.use = function(me, reducers) {
  ...
  this.aggregate._get_mix = (function(_this) {
    return function(reducers) {
      if ((reducers == null) || (Object.keys(reducers)).length === 0) {
        return _this.aggregate._mix;
      }
      return mix.use(reducers);
    };
  })(this);
  ...
  this.aggregate._mix = this.aggregate._get_mix(this.aggregate._reducers);
