...
(function() {
  var CND, alert, append, as_number, as_numbers, badge, debug, echo, fuse, help, info, log, meld, minus_aleph, normalize_points, normalize_tag, plus_aleph, rpr, setting_keys_of_cover_and_intersect, sort_entries_by_insertion_order, sort_ids_by_insertion_order, unique, urge, warn, whisper,
    slice = [].slice,
  ...
  this.cover = function(me, points, settings) {
    if (settings == null) {
      settings = {};
    }
    return this._cover_or_intersect(me, 'cover', points, settings);
  };
  ...
  this.find_ids = function(me, point) {
    return this._find_ids_with_all_points(me, point);
  };
  ...
  this.find_entries_with_any_points = function() {
    ...
    return this.entries_of(me, this._find_ids_with_any_points.apply(this, [me].concat(slice.call(P))));
  };

  this.find_entries_with_all_points = function() {
    var P, me;
    me = arguments[0], P = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    return this.entries_of(me, this._find_ids_with_all_points.apply(this, [me].concat(slice.call(P))));
  };
