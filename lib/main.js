...
(function() {
  var CND, alert, append, as_number, as_numbers, badge, debug, echo, fuse, help, info, log, meld, normalize_points, normalize_tag, reduce_tag, rpr, setting_keys_of_cover_and_intersect, sort_entries_by_insertion_order, sort_ids_by_insertion_order, unique, urge, warn, whisper, σ_minus_aleph, σ_plus_aleph,
    slice = [].slice,
  ...
  this["new"] = function(settings) {
    ...
    isl_settings = {
      ...
      compare: function(a, b) {
        if (a === b && (a === σ_plus_aleph || a === σ_minus_aleph)) {
          return 0;
        }
        if ((a === σ_plus_aleph) || (b === σ_minus_aleph)) {
          return +1;
        }
        if ((a === σ_minus_aleph) || (b === σ_plus_aleph)) {
          return -1;
        }
        if (a > b) {
          return +1;
