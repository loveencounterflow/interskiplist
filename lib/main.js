...
(function() {
  var CND, alert, append, as_number, as_numbers, badge, debug, echo, fuse, help, info, log, meld, normalize_points, normalize_tag, reduce_tag, rpr, setting_keys_of_cover_and_intersect, sort_entries_by_insertion_order, sort_ids_by_insertion_order, unique, urge, warn, whisper, σ_minus_א, σ_misfit, σ_plus_א,
    slice = [].slice,
  ...
  this.aggregate = function(me, point, reducers) {
    var R, averages, cache, count, entries, entry, exclude, functions, i, id, ids, ids_and_values, key, len, mix, point_count, reducer, reducer_fallback, reducer_include, ref, ref1, ref2, ref3, ref4, standard_mix, standard_reducers, sum, tag_keys, target, value, values;
    if (reducers == null) {
      reducers = {};
    }
    ...
    help('7309', standard_mix.apply(null, entries));
    R = {};
    cache = {};
    averages = {};
