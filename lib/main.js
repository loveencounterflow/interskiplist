...
(function() {
  ...
  this.aggregate = function(me, points_or_entries, reducers) {
    var R, averages, cache, common, count, entries, entry, exclude, i, ids_and_values, j, key, len, len1, points, points_or_entry, reducer, reducer_fallback, ref, ref1, ref2, ref3, ref4, sum, tag_keys, target, value, values;
    if (reducers == null) {
      reducers = {};
    }
