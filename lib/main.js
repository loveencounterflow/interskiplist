...
(function() {
  ...
  this.aggregate = function(me, points_or_entries, reducers) {
    var R, averages, cache, count, entries, entry, exclude, functions, i, id, ids, ids_and_values, j, key, len, len1, points, points_or_entry, reducer, reducer_fallback, reducer_include, ref, ref1, ref2, ref3, ref4, ref5, sum, tag_keys, target, value, values;
    if (reducers == null) {
      reducers = {};
    }
    ...
    for (key in cache) {
      ...
      ids = (function() {
        ...
        results = [];
        for (k = 0, len2 = ids_and_values.length; k < len2; k++) {
          ref6 = ids_and_values[k], id = ref6[0], value = ref6[1];
          results.push(id);
        }
        return results;
      })();
