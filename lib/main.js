...
(function() {
  ...
  this.aggregate = function(me, points_or_entries, reducers) {
    var R, averages, cache, count, entries, entry, exclude, functions, i, ids_and_values, j, key, len, len1, points, points_or_entry, reducer, reducer_fallback, ref, ref1, ref2, ref3, ref4, ref5, sum, tag_keys, target, value;
    if (reducers == null) {
      reducers = {};
    }
