...
(function() {
  ...
  this.aggregate.use = (function(_this) {
    return function(me, reducers, settings) {
      ...
      if ((reducers == null) || (Object.keys(reducers)).length === 0) {
        ...
        fields = Object.assign.apply(Object, [{}].concat(slice.call((function() {
          var i, len, results;
          results = [];
      ...
      mix_entries_of_point = function(point) {
        ...
        return my_mix.apply(null, entries);
      };
      if (!memoize) {
