...
(function() {
  ...
  this.aggregate.use = (function(_this) {
    return function(me, reducers) {
      var reducer_mixins;
      if ((reducers == null) || (Object.keys(reducers)).length === 0) {
        mix = _this.aggregate._mix;
      } else {
        reducer_mixins = [{}];
        reducer_mixins.push(_this.aggregate._reducers);
      ...
      return function(point) {
        ...
        entries = _this.entries_of(me, _this._find_ids_with_any_points(me, point));
