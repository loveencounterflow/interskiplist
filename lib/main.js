...
(function() {
  var CND, alert, append, as_number, as_numbers, badge, debug, echo, fuse, help, info, log, meld, normalize_points, normalize_tag, reduce_tag, rpr, setting_keys_of_cover_and_intersect, sort_entries_by_insertion_order, sort_ids_by_insertion_order, unique, urge, warn, whisper, σ_minus_א, σ_plus_א,
    slice = [].slice,
